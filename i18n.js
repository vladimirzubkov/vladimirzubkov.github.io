/** EN / CS / RU for CV. Default: English. */
(function (global) {
  ...
  /* RU: interleaved Cyrillic→Latin (а before a, б before b, …), not two separate blocks.
     Every Latin letter sits with its closest Cyrillic pair; extras w/q/c/x with в/к/с/х. */
  var RU_MIXED_ALPHABET =
    "аaбbвvwгgдdеeёжзzиiйjкkqлlмmнnоoпpрrсscтtуuфfхhxцчшщъыyьэюя";
  ...
  function demoPrintLink(href, screenLabel, duration) {
    var display = href.replace(/^https?:\/\//, "");
    var screenText = screenLabel + "&nbsp;" + duration;
    var printText = display + "&nbsp;" + duration;
    return (
      '<a href="' +
      href +
      '" class="print-explicit-url project-demo"><span class="link-screen">' +
      screenText +
  ...
  function patchWorkPrintLinks(lang, repoLabel, demoLabel) {
    ...
    var demoRe = /<a href="(https:\/\/youtu\.be\/[^"]+)"(?: class="project-demo")?>(?:youtube|ютуб)&nbsp;(\([^)]+\))<\/a>/g;
    WORK_KEYS.forEach(function (key) {
      if (!pack[key]) return;
      pack[key] = pack[key].replace(repoRe, function (_, href) {
        return repoPrintLink(href, repoLabel);
      });
      pack[key] = pack[key].replace(demoRe, function (_, href, duration) {
        return demoPrintLink(href, demoLabel, duration);
      });
    });
  }
  ...
  var strings = {
    en: {
      ...
      lede_3:
        "Alongside growing in software development, I am always interested in AI, new materials, and medicine.",
      contacts_line:
      ...
      work_it_title: "IT work in the field (in development, won't be printed)",
      work_it_empty:
      ...
      work_it_print:
        "Looking to join a professional team building reliable multi-user enterprise systems. Open to ~20 hours per week alongside studies, with flexibility during exams. Direct communication style.",
      ...
      work_arimaa:
        '<strong>Arimaa</strong> — Java/JavaFX desktop game — MVC, rule engine, Minimax AI, TCP multiplayer, JUnit tests; semester project from the course Programming in Java (B0B36PJV). <a href="https://github.com/vladimirzubkov/sem-pjv-arimaa">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/r9iUenDT7Mc" class="project-demo">youtube&nbsp;(5:52)</a>.',
      work_seafood:
        '<strong>Smart Seafood Chain</strong> — discrete-event supply chain simulation — blockchain traceability, YAML config, GoF patterns; semester project from the course Object-Oriented Design and Modeling (B6B36OMO). <a href="https://github.com/vladimirzubkov/sem-omo-seafoodchain">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/dXqcA6DoE4Y" class="project-demo">youtube&nbsp;(3:00)</a>.',
      work_alladin:
        '<strong>Alladin the Bargainer</strong> — marketplace with AI price negotiation — Spring Boot, React, PostgreSQL, Docker; team project from the course Management of Software Projects (B6B36PM2). <a href="https://github.com/vladimirzubkov/sem-pm2-alladin">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/VAAVRtKAdAs" class="project-demo">youtube&nbsp;(5:00)</a>.',
      work_aletheia:
        '<strong>Aletheia</strong> — university course scheduling API — Spring Boot, JPA, Security, Docker, Swagger; semester project from the course Enterprise Architectures (B6B36EAR). <a href="https://github.com/vladimirzubkov/sem-ear-aletheia">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/mcfM8FFkskw" class="project-demo">youtube&nbsp;(3:00)</a>.',
      work_auctionhouse:
        '<strong>Auction House</strong> — english auction monolith — Spring Boot, Kafka, PostgreSQL, Docker, Swagger; semester project from the course Software Systems Design (B6B36NSS). <a href="https://github.com/vladimirzubkov/sem-nss-auctionhouse">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/u66x9WjObQ0" class="project-demo">youtube&nbsp;(3:00)</a>.',
      sports: "Sports",
      sports_body: "Tennis, swimming, basketball, jogging, amateur chess.",
      hosted: "Hosted on GitHub Pages ·",
      visitor_today: "today",
      visitor_total: "total",
      how_built: "How it's built",
      how_built_stack: "Stack: HTML, CSS, vanilla JS · GitHub Actions · GitHub Pages",
      how_built_box_local: "Local files",
      how_built_arrow_push: "git push to private repo",
      how_built_box_private: "Private GitHub · full source",
      how_built_arrow_ci: "Actions publishes static files",
      how_built_box_public: "Public repo · one orphan commit",
      how_built_arrow_pages: "GitHub Pages",
      how_built_box_site: "vladimirzubkov.github.io",
      how_built_counters:
        "Counters: Vercel + Redis. One unique visit per day. We do not know your IPs, this is a third-party badge.",
      how_built_ui: "Language and bar pin: localStorage, this browser only.",
      updated: "Updated",
    ...
    cs: {
      ...
      lede_3:
        "Kromě profesního rozvoje ve vývoji softwaru mě zajímá AI, nové materiály a medicína.",
      contacts_line:
      ...
      work_it_title: "Práce v IT v oboru (ve vývoji, nebude vytištěno)",
      work_it_empty:
      ...
      work_it_print:
        "Hledám práci v profesionálním týmu na spolehlivých víceuživatelských podnikových systémech. Otevřen cca 20 hodinám týdně vedle studia, s flexibilitou ve zkouškovém období. Preferuji přímý styl komunikace.",
      ...
      work_arimaa:
        '<strong>Arimaa</strong> — desktopová hra v Java/JavaFX — MVC, herní pravidla, Minimax AI, TCP multiplayer, JUnit testy; semestrální práce z předmětu Programování v Javě (B0B36PJV). <a href="https://github.com/vladimirzubkov/sem-pjv-arimaa">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/r9iUenDT7Mc" class="project-demo">youtube&nbsp;(5:52)</a>.',
      work_seafood:
        '<strong>Smart Seafood Chain</strong> — diskrétní simulace dodavatelského řetězce — blockchain, YAML konfigurace, návrhové vzory; semestrální práce z předmětu Objektový návrh a modelování (B6B36OMO). <a href="https://github.com/vladimirzubkov/sem-omo-seafoodchain">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/dXqcA6DoE4Y" class="project-demo">youtube&nbsp;(3:00)</a>.',
      work_alladin:
        '<strong>Alladin the Bargainer</strong> — inzertní portál s AI vyjednáváním cen — Spring Boot, React, PostgreSQL, Docker; týmový projekt z předmětu Řízení softwarových projektů (B6B36PM2). <a href="https://github.com/vladimirzubkov/sem-pm2-alladin">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/VAAVRtKAdAs" class="project-demo">youtube&nbsp;(5:00)</a>.',
      work_aletheia:
        '<strong>Aletheia</strong> — backend pro rozvrhování kurzů — Spring Boot, JPA, Security, Docker, Swagger; semestrální práce z předmětu Enterprise architektury (B6B36EAR). <a href="https://github.com/vladimirzubkov/sem-ear-aletheia">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/mcfM8FFkskw" class="project-demo">youtube&nbsp;(3:00)</a>.',
      work_auctionhouse:
        '<strong>Auction House</strong> — monolit anglické aukce — Spring Boot, Kafka, PostgreSQL, Docker, Swagger; semestrální práce z předmětu Návrh softwarových systémů (B6B36NSS). <a href="https://github.com/vladimirzubkov/sem-nss-auctionhouse">GitHub</a>, demo:&nbsp;<a href="https://youtu.be/u66x9WjObQ0" class="project-demo">youtube&nbsp;(3:00)</a>.',
      sports: "Sporty",
      sports_body: "Tenis, plavání, basketbal, běh klusem, amatérské šachy.",
      hosted: "Hostováno na GitHub Pages ·",
      visitor_today: "dnes",
      visitor_total: "celkem",
      how_built: "Jak to vzniká",
      how_built_stack: "Stack: HTML, CSS, vanilla JS · GitHub Actions · GitHub Pages",
      how_built_box_local: "Lokální soubory",
      how_built_arrow_push: "git push do soukromého repa",
      how_built_box_private: "Soukromý GitHub · celý zdroj",
      how_built_arrow_ci: "Actions publikuje statiku",
      how_built_box_public: "Veřejné repo · jeden orphan commit",
      how_built_arrow_pages: "GitHub Pages",
      how_built_box_site: "vladimirzubkov.github.io",
      how_built_counters:
        "Počitadla: Vercel + Redis. Jedna unikátní návštěva za den. Vaše IP adresy neznáme, jde o badge třetí strany.",
      how_built_ui: "Jazyk a připnutí panelu: localStorage, jen tento prohlížeč.",
    ...
    ru: {
      ...
      lede_3:
        "Помимо развития в создании программного обеспечения, меня интересует ИИ, новые материалы и медицина.",
      contacts_line:
      ...
      work_it_title: "Работа в IT по специальности (в разработке, не печатается)",
      work_it_empty:
      ...
      work_it_print:
        "Ищу работу в профессиональной команде над надёжными многопользовательскими корпоративными системами. Открыт к ~20 часам в неделю параллельно с учёбой, с гибкостью в сессию. Предпочитаю прямой стиль общения.",
      ...
      work_arimaa:
        '<strong>Arimaa</strong> — настольная игра на Java/JavaFX — MVC, движок правил, Minimax AI, TCP-мультиплеер, JUnit-тесты; курсовая работа по предмету «Программирование на Java» (B0B36PJV). <a href="https://github.com/vladimirzubkov/sem-pjv-arimaa">Гитхаб</a>, демо:&nbsp;<a href="https://youtu.be/r9iUenDT7Mc" class="project-demo">ютуб&nbsp;(5:52)</a>.',
      work_seafood:
        '<strong>Smart Seafood Chain</strong> — дискретная симуляция цепочки поставок — blockchain, YAML-конфигурация, паттерны GoF; курсовая работа по предмету «Объектное проектирование и моделирование» (B6B36OMO). <a href="https://github.com/vladimirzubkov/sem-omo-seafoodchain">Гитхаб</a>, демо:&nbsp;<a href="https://youtu.be/dXqcA6DoE4Y" class="project-demo">ютуб&nbsp;(3:00)</a>.',
      work_alladin:
        '<strong>Alladin the Bargainer</strong> — маркетплейс с AI-переговорами о цене — Spring Boot, React, PostgreSQL, Docker; командный проект по предмету «Управление программными проектами» (B6B36PM2). <a href="https://github.com/vladimirzubkov/sem-pm2-alladin">Гитхаб</a>, демо:&nbsp;<a href="https://youtu.be/VAAVRtKAdAs" class="project-demo">ютуб&nbsp;(5:00)</a>.',
      work_aletheia:
        '<strong>Aletheia</strong> — API для расписания курсов — Spring Boot, JPA, Security, Docker, Swagger; курсовая работа по предмету «Enterprise-архитектуры» (B6B36EAR). <a href="https://github.com/vladimirzubkov/sem-ear-aletheia">Гитхаб</a>, демо:&nbsp;<a href="https://youtu.be/mcfM8FFkskw" class="project-demo">ютуб&nbsp;(3:00)</a>.',
      work_auctionhouse:
        '<strong>Auction House</strong> — монолит английского аукциона — Spring Boot, Kafka, PostgreSQL, Docker, Swagger; курсовая работа по предмету «Проектирование программных систем» (B6B36NSS). <a href="https://github.com/vladimirzubkov/sem-nss-auctionhouse">Гитхаб</a>, демо:&nbsp;<a href="https://youtu.be/u66x9WjObQ0" class="project-demo">ютуб&nbsp;(3:00)</a>.',
      sports: "Виды спорта",
      ...
      visitor_total: "всего",
      how_built: "Как это сделано",
      how_built_stack: "Стек: HTML, CSS, vanilla JS · GitHub Actions · GitHub Pages",
      how_built_box_local: "Локальные файлы",
      how_built_arrow_push: "git push в приватный репозиторий",
      how_built_box_private: "Приватный GitHub · полный исходник",
      how_built_arrow_ci: "Actions публикует статику",
      how_built_box_public: "Публичный репозиторий · один orphan-коммит",
      how_built_arrow_pages: "GitHub Pages",
      how_built_box_site: "vladimirzubkov.github.io",
      how_built_counters:
        "Счётчики: Vercel + Redis. Один уникальный заход в день. Мы не знаем ваши IP, это сторонний виджет.",
      how_built_ui: "Язык и закрепление панели: localStorage, только этот браузер.",
      updated: "Обновлено",
  ...
  var VISITOR_COUNT_KEY = "vladimirzubkov.github.io-cv-2";
  ...
  function initStickyTopbar() {
    ...
    toggle.addEventListener("change", function () {
      ...
      setSticky(on);
      syncTopbarLine();
      persistLocal(STICKY_KEY, on ? "1" : "0");
    });
